    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            for(let i=0; i<data.length; i++) {
                ...
                html += `                <div class="title">주문 내용</div>`;
                html += `            </div>`;
                html += `            <input type="text" name="name" class="data-input" placeholder="주문 내용을 입력해주세요." value="${data[i].name}">`;
                html += `        </div>`;
                html += `    </div>`;
            ...
            for(let i=10; i>data.length; i--) {
                ...
                html += `                <div class="title">주문 내용</div>`;
                html += `            </div>`;
                html += `            <input type="text" name="name" class="data-input" placeholder="주문 내용을 입력해주세요.">`;
                html += `        </div>`;
                html += `    </div>`;
                html += `    <div class="code_box__bottom flex-between">`;
                html += `        <div class="toggle_box">`;
